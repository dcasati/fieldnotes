...
.. list-table::   
   ...
   * - Primary  
     ...
     - Most commonly used methods of communication.  
   * - Alternate  
     - Phone calls  
     - Used if the primary methods are not working.  
   * - Contingency  
     - FRS radios, Amateur Radio, Winlink, APRS  
     - Used if the primary and alternate methods fail.  
   * - Emergency  
     - Zoleo satellite device  
     - Used as a last resort when all other methods of communication are unavailable.  
  
Remember, the key to a successful PACE plan is to ensure everyone involved understands the plan and knows how to use each method of communication. Regularly test and update the plan as needed.  
